...
def statistical_comparison(fan_stats, judge_stats, save_dir):
    """统计比较与可视化"""
    print("\n" + "=" * 70)
    ...
    summary.to_csv(f'{save_dir}/distribution_comparison.csv', index=False)
...
def main():
    ...
    data_csv = rf"{base_dir}\dataset\2026_MCM_Problem_C_Data.csv"
    fan_csv = rf"{base_dir}\dataset\fan_vote_shares.csv"
    ...
    # 统计比较
    statistical_comparison(fan_stats, judge_stats, save_dir)
    
    # 可视化
    visualize_distributions(fan_stats, judge_stats, save_dir)
