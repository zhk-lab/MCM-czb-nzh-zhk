...
- 评委分数模型：R^2 = 0.8263（解释82.6%方差）
- 粉丝投票模型：R^2 = 0.5376（解释53.8%方差）
- 评委-粉丝相关性（rho）：-0.2085（弱负相关，偏好基本独立）
...
- **舞者-行业匹配度**: 评委=+0.074，粉丝=-0.027**
- **同季竞争强度**: 评委=+0.129，粉丝=-0.292***
- **年龄（标准化）**: 评委=-0.247**，粉丝=+0.025
- **名人可见度**: 评委=+0.307*，粉丝=-0.027
- **赛前人气**: 评委=+0.120*，粉丝=-0.092***
...
4. **评委-粉丝相关性ρ=-0.208（基本独立）**，共同方差仅4.3%
